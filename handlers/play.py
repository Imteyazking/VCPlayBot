...
async def play(client: Client, message_: Message):
    ...
    res = await message_.reply_text("✯VC Imteyaz✯=🔄 Processing...")
    ...
    if message_.chat.id in tgcalls.pytgcalls.active_calls:
        ...
        await res.edit_text(f"✯𝗩𝗖 Imteyaz✯=#️⃣ Queued at position {position}.")
    else:
        await res.edit_text("✯𝗩𝗖 Imteyaz✯=▶️ Playing...")
        res.delete
        m = await client.send_photo(
        chat_id=message_.chat.id,
        photo="https://telegra.ph/file/a1887512c6b0f55c9dc5a.jpg",
        caption=f"Playing Your song Via  [✯𝗩𝗖 Imteyaz✯](https://t.me/Awesome_support).",
         ) 
...
async def jiosaavn(client: Client, message_: Message):
    ...
    m = await client.send_photo(
        chat_id=message_.chat.id,
        caption=f"Playing {sname} Via [Jiosaavn](https://t.me/Awesome_support)",
        photo="final.png",
    )
    os.remove("final.png")
