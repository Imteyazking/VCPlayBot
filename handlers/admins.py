...
async def resume(client: Client, message: Message):
    ...
    await message.reply_text("✯𝗩𝗖 Imteyaz ab chaalu ho✯=▶️ Resumed.")
...
async def stop(client: Client, message: Message):
    ...
    await message.reply_text("✯𝗩𝗖ImteyazBot ✯=⏹ Stopped streaming.")
...
async def skip(client: Client, message: Message):
    ...
    if sira.is_empty(chat_id):
        ...
        await message.reply_text("✯𝗩𝗖 Imteyaz 𝗕𝗼𝘁✯=⏩ Skipped the current song.")
...
async def admincache(client, message: Message):
    ...
    await message.reply_text("✯𝗩𝗖 Imteyaz 𝗕𝗼𝘁✯=❇️ Admin cache refreshed!")
